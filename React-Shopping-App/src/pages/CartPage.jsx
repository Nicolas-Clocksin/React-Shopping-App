...
function CartPage() {
    const { cartItems, removeFromCart, totalCost, quantity } = useContext(CartContext);
                ...
                {cartItems.map(cartItem=> (
                    <ListGroup.Item key={cartItem.item.id} className="cartListItem">
                        ...
                        <div className="cartListItem-right">
                            ...
                            <i className="bi bi-trash cartListItem-delete" onClick={()=> removeFromCart(cartItem.item.id)}></i>
